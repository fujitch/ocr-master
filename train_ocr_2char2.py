...
model = chainer.FunctionSet(conv1=L.Convolution2D(1, 32, 6),
                            ...
                            conv3=L.Convolution2D(64, 256, 5),
                            conv4=L.Convolution2D(256, 512, 4),
                            conv5=L.Convolution2D(512, 2048, 3),
                            conv6=L.Convolution2D(2048, 4096, 3),
                            conv7=L.Convolution2D(4096, 8192, 2),
                            l1 = L.Linear(8192, 4096),
...
pickle.dump(lossMatrix, open('lossMatrix.pkl', 'wb'))
